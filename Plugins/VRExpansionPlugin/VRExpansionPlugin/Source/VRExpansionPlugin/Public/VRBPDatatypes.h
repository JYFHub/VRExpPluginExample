...
enum class EVRCustomMovementMode : uint8
{
	...
	VRMOVE_DynamicGravityWalking UMETA(DisplayName = "DynamicGravityWalking")
...
enum class EVRConjoinedMovementModes : uint8
{
	...
	C_VRMOVE_DynamicGravityWalking = 0x0B UMETA(DisplayName = "DynamicGravityWalking"),
	C_VRMOVE_Custom1 = 0x0C UMETA(DisplayName = "Custom2"),
	C_VRMOVE_Custom2 = 0x0D UMETA(DisplayName = "Custom3"),
	C_VRMOVE_Custom3 = 0x0E UMETA(DisplayName = "Custom4"),
	C_VRMOVE_Custom4 = 0x0F UMETA(DisplayName = "Custom5")
};
